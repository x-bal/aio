...
(function (cash) {
  ...
  cash("body").on("click", ".accordion-button", function () {
    ...
    velocity_animate__WEBPACK_IMPORTED_MODULE_0___default()(
    ...
    cash(`[data-loading-icon]`).each(function () {
      let color =
        cash(this).data("color") !== undefined
          ...
          : cash("body").css("color");
      let classAttr =
        cash(this).attr("class") !== undefined ? cash(this).attr("class") : "";
      let icons = [
        {
          name: "audio",
          svg: `
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _bootstrap__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./bootstrap */ "./js/bootstrap.js");
/* harmony import */ var _tw_starter__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./tw-starter */ "./js/tw-starter.js");
/* harmony import */ var _feather__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./feather */ "./js/feather.js");
/* harmony import */ var _tippy__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./tippy */ "./js/tippy.js");
/* harmony import */ var _search__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./search */ "./js/search.js");
...
/* harmony import */ var _show_code__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./show-code */ "./js/show-code.js");
/* harmony import */ var _side_menu__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./side-menu */ "./js/side-menu.js");
/* harmony import */ var _mobile_menu__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./mobile-menu */ "./js/mobile-menu.js");
/* harmony import */ var _side_menu_tooltip__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./side-menu-tooltip */ "./js/side-menu-tooltip.js");
/* harmony import */ var _dark_mode_switcher__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./dark-mode-switcher */ "./js/dark-mode-switcher.js");
/* harmony import */ var _dark_mode_switcher__WEBPACK_IMPORTED_MODULE_9___default = /*#__PURE__*/__webpack_require__.n(_dark_mode_switcher__WEBPACK_IMPORTED_MODULE_9__);
/*
 |--------------------------------------------------------------------------
 | 3rd Party Libraries
 |--------------------------------------------------------------------------
...
window.cash = (cash_dom__WEBPACK_IMPORTED_MODULE_0___default()); // window.helper = helper;

window.Velocity = (velocity_animate__WEBPACK_IMPORTED_MODULE_1___default());
window.Popper = _popperjs_core__WEBPACK_IMPORTED_MODULE_2__;

/***/ }),

/***/ "./js/dark-mode-switcher.js":
/*!**********************************!*\
  !*** ./js/dark-mode-switcher.js ***!
  \**********************************/
/***/ (() => {
...
(function (cash) {
  ...
  cash("#mobile-menu-toggler").on("click", function () {
    if (cash(".mobile-menu").find("ul").first()[0].offsetParent !== null) {
      velocity_animate__WEBPACK_IMPORTED_MODULE_0___default()(cash(".mobile-menu").find("ul").first(), "slideUp");
    } else {
      velocity_animate__WEBPACK_IMPORTED_MODULE_0___default()(cash(".mobile-menu").find("ul").first(), "slideDown");
    }
  });
  cash(".mobile-menu").find(".menu").on("click", function () {
    if (cash(this).parent().find("ul").length) {
      if (cash(this).parent().find("ul").first()[0].offsetParent !== null) {
        ...
        velocity_animate__WEBPACK_IMPORTED_MODULE_0___default()(cash(this).parent().find("ul").first(), "slideUp", {
          duration: 300,
        ...
        velocity_animate__WEBPACK_IMPORTED_MODULE_0___default()(cash(this).parent().find("ul").first(), "slideDown", {
          duration: 300,
          complete: function complete(el) {
...
(function (cash) {
  ...
  cash("body").on("change", ".show-code", function () {
    ...
    if (cash(this).is(":checked")) {
      ...
      velocity_animate__WEBPACK_IMPORTED_MODULE_0___default()(cash(elementId).find(".source-code"), "fadeIn");
    } else {
      velocity_animate__WEBPACK_IMPORTED_MODULE_0___default()(cash(elementId).find(".preview"), "fadeIn");
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _left4code_tw_starter_dist_js_svg_loader__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @left4code/tw-starter/dist/js/svg-loader */ "./node_modules/@left4code/tw-starter/dist/js/svg-loader.js");
/* harmony import */ var _left4code_tw_starter_dist_js_accordion__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @left4code/tw-starter/dist/js/accordion */ "./node_modules/@left4code/tw-starter/dist/js/accordion.js");
/* harmony import */ var _left4code_tw_starter_dist_js_alert__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @left4code/tw-starter/dist/js/alert */ "./node_modules/@left4code/tw-starter/dist/js/alert.js");
/* harmony import */ var _left4code_tw_starter_dist_js_dropdown__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @left4code/tw-starter/dist/js/dropdown */ "./node_modules/@left4code/tw-starter/dist/js/dropdown.js");
/* harmony import */ var _left4code_tw_starter_dist_js_modal__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @left4code/tw-starter/dist/js/modal */ "./node_modules/@left4code/tw-starter/dist/js/modal.js");
/* harmony import */ var _left4code_tw_starter_dist_js_tab__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! @left4code/tw-starter/dist/js/tab */ "./node_modules/@left4code/tw-starter/dist/js/tab.js");
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkonepage_doorlock_tzk"] = self["webpackChunkonepage_doorlock_tzk"] || [];
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["dist/css/app"], () => (__webpack_require__("./sass/app.scss")))
