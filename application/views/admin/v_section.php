          ...
          <div class="col-xs-12">
            <div class="box">
              <div class="box-header">
                ...
                <a href="<?=base_url()?>admin/add_section/<?=$id_department;?>"><button type="button" class="btn btn-danger btn-md">Tambah Section</button></a>
                <br><br>
                <h1 class="box-title">Department <?=$nama_department;?></h1>
              </div>
              <!-- /.box-header -->
              <div class="box-body table-responsive">
                <table id="t1" class="table table-bordered table-striped">
                  ...
                  <tr>
                    ...
                    <th style="text-align:center">Nama Section</th>
                  ...
                  <tr>
                    ...
                    <td style="text-align:center">
                      <a href="<?=base_url()?>admin/edit_section/<?=$row->id_section;?>" class="btn btn-primary btn-sm"><i class="glyphicon glyphicon-pencil"></i></a>
                      <a href="<?=base_url()?>admin/hapus_section/<?=$row->id_section;?>" class="btn btn-danger btn-sm" onclick="return confirm('Anda Yakin menghapus data ini?')"><i class="glyphicon glyphicon-trash"></i></a>
                    </td>
                  </tr>
                  <?php }}?>
  ...
  ?>
    <div class="content-wrapper">
      ...
      <section class="content-header">
        ...
        <ol class="breadcrumb">
          <li><a href="<?=base_url();?>admin/department"><i class="fa fa-building"></i> Department</a></li>
          <li class="active">Tambah Section</li>
        </ol>
      </section>
        ...
        <div class="row">
          <div class="col-xs-12">
            <div class="box">
              ...
              <!-- /.box-header -->
              <form role="form" action="<?=base_url();?>admin/save_section" method="post">
                <div class="box-body">
                  <div class="form-group">
                  <input type="hidden" name="id_department" value="<?=$id_department;?>">
                    <label>Nama Section</label>
                    <input type="text" name="nama_section" class="form-control" placeholder="Enter name" required>
                  </div>
                </div>
        ...
        <div class="row">
          <div class="col-xs-12">
            <div class="box">
              ...
              <!-- /.box-header -->
              <form role="form" action="<?=base_url();?>admin/save_edit_section" method="post">
                <div class="box-body">
                  <div class="form-group">
                    <input type="hidden" name="id_department" value="<?=$id_department;?>">
                    <input type="hidden" name="id_section" value="<?=$id_section;?>">
                    <label>Nama Section</label>
                    <input type="text" name="nama_section" class="form-control" placeholder="Enter name" value="<?=$nama_section;?>" required>
                  </div>
                </div>
