    ...
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                ...
                <ol class="breadcrumb">
                    <li><a href="<?= base_url(); ?>admin/notif"><i class="fa fa-exclamation"></i> Notif Door</a></li>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="box">
                            ...
                            <div class="box-body">
                                <a href="<?= base_url('admin/notif-door/create') ?>" class="btn btn-sm btn-primary" style="margin-bottom: 20px;">Tambah</a>
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="<?= base_url('admin/notif-door/edit/' . $notif->id_telegram_door) ?>" class="btn btn-sm btn-success"><i class="fa fa-edit"></i></a>

                                                        <a href="" title="Tes Notif Telegram" class="btn btn-sm btn-info"><i class="fa fa-telegram"></i></a>

                                                        <a href="<?= base_url('admin/notif-door/delete/' . $notif->id_telegram_door) ?>" class="btn btn-sm btn-danger" onclick="return confirm('Hapus data berikut ?')"><i class="fa fa-trash"></i></a>
                                                    </td>
                                                </tr>
                                            <?php endforeach; ?>
                                        </tbody>
