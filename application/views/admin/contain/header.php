    ...
    <ul class="sidebar-menu" data-widget="tree">
      ...
      ?>
        ...
        ?>
          ...
          <li <?php if ($this->uri->segment(2) == "list_room_dep") {
                echo 'class="active"';
              } ?>>
