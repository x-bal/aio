            ...
            <div class="box">
              ...
              <?php echo form_open_multipart(base_url().'admin/save_edit_admin'); ?>
                <div class="box-body">
                  ...
                  <div class="form-group">
                    <img src="<?=base_url();?>component/dist/img/admin/<?php if(isset($gambar)){echo $gambar;}?>" width="auto" height="200px"><br>
                    <input type="hidden" name="img" value="<?php if(isset($gambar)){echo $gambar;}?>">
                    <label for="InputFile">Pilih Foto ("jpg", "jpeg", "gif", "png")</label>
