    ...
    ?>
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            <li><a href="<?= base_url(); ?>karyawan/department"><i class="fa fa-window-restore"></i> Monitoring Room</a></li>
            <!-- <li class="active"></li> -->
          </ol>
        </section>
            ...
            <div class="col-xs-12">
              <div class="box">
                ...
                <div class="box-body text-center">
                  ...
                  <div class="col-md-4">
                    <form role="form" action="<?= base_url(); ?>karyawan/monitoringdep" method="get">
