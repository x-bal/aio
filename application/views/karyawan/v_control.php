    ...
    ?>
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            <li><a href="<?= base_url(); ?>karyawan/control"><i class="fa fa-keyboard-o"></i> Control Room</a></li>
            <!-- <li class="active"></li> -->
          </ol>
        </section>
        <!-- BEGIN: Content -->
              ...
              <div class="col-md-12">
                <div class="card">
                  <div class="card-header text-center" style="background-color: #004d9f; border-top-left-radius: 10px; border-top-right-radius: 10px;">
                    <form role="form" action="<?= base_url(); ?>karyawan/control" method="get">
                                            ...
                                            ?>
                                              ...
                                              <div class="mt-1">
                                                ...
                                                <div class="form-check">
                                                  <form role="form" action="<?= base_url(); ?>karyawan/control_relay" method="post">
                                          ...
                                          <div class="p-2">
                                            <div class="mt-2 text-center form-group">
                                              ...
                                              <div class="mt-1">
                                                ...
                                                <div class="form-check">
                                                  <form role="form" action="<?= base_url(); ?>karyawan/positionswitch" method="post">
                                                    <input type="hidden" name="id_room" value="<?= $door->id_room; ?>">
                                                    <input type="hidden" name="link" value="<?= $link; ?>">
    ...
    ?>
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            <li><a href="<?= base_url(); ?>karyawan/department"><i class="fa fa-building"></i> Department</a></li>
          ...
          <div class="row">
            <div class="col-xs-12">
              <div class="box">
                ...
                <!-- /.box-header -->
                <form role="form" action="<?= base_url(); ?>karyawan/save_edit_department" method="post">
                  <div class="box-body">
                    <div class="form-group">
