...
-- Dumping database structure for aio
CREATE DATABASE IF NOT EXISTS `aio` /*!40100 DEFAULT CHARACTER SET latin1 */;
USE `aio`;

-- Dumping structure for table aio.access_room_karyawan
CREATE TABLE IF NOT EXISTS `access_room_karyawan` (
  `id_access_room_karyawan` int(11) NOT NULL AUTO_INCREMENT,
  `id_karyawan` int(11) NOT NULL,
  `id_room` int(11) NOT NULL,
  PRIMARY KEY (`id_access_room_karyawan`)
) ENGINE=InnoDB AUTO_INCREMENT=15 DEFAULT CHARSET=latin1;

-- Dumping data for table aio.access_room_karyawan: ~11 rows (approximately)
/*!40000 ALTER TABLE `access_room_karyawan` DISABLE KEYS */;
INSERT INTO `access_room_karyawan` (`id_access_room_karyawan`, `id_karyawan`, `id_room`) VALUES
	...
	(13, 8, 2),
	(14, 8, 5);
/*!40000 ALTER TABLE `access_room_karyawan` ENABLE KEYS */;

-- Dumping structure for table aio.department
...
-- Dumping data for table aio.department: ~6 rows (approximately)
...
-- Dumping structure for table aio.department_section
...
-- Dumping data for table aio.department_section: ~7 rows (approximately)
...
-- Dumping structure for table aio.device_rfid
CREATE TABLE IF NOT EXISTS `device_rfid` (
  `id_device_rfid` int(11) NOT NULL AUTO_INCREMENT,
  `id_department` int(11) NOT NULL,
  `status` tinyint(1) NOT NULL,
  `data_rfid` varchar(100) NOT NULL,
  `created_at` int(11) NOT NULL,
  `deleted` tinyint(1) NOT NULL,
  PRIMARY KEY (`id_device_rfid`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=latin1;

-- Dumping data for table aio.device_rfid: ~2 rows (approximately)
/*!40000 ALTER TABLE `device_rfid` DISABLE KEYS */;
INSERT INTO `device_rfid` (`id_device_rfid`, `id_department`, `status`, `data_rfid`, `created_at`, `deleted`) VALUES
	(1, 1, 0, '-', 1601257352, 0),
	(2, 1, 0, '-', 1601258495, 0);
/*!40000 ALTER TABLE `device_rfid` ENABLE KEYS */;

-- Dumping structure for table aio.free_access_room
CREATE TABLE IF NOT EXISTS `free_access_room` (
  `id_free_access_room` int(11) NOT NULL AUTO_INCREMENT,
  `id_karyawan` int(11) NOT NULL,
  PRIMARY KEY (`id_free_access_room`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

-- Dumping data for table aio.free_access_room: ~0 rows (approximately)
/*!40000 ALTER TABLE `free_access_room` DISABLE KEYS */;
/*!40000 ALTER TABLE `free_access_room` ENABLE KEYS */;

-- Dumping structure for table aio.karyawan
...
-- Dumping data for table aio.karyawan: ~8 rows (approximately)
...
INSERT INTO `karyawan` (`id_karyawan`, `id_section`, `id_position`, `nik`, `password`, `nama_karyawan`, `status`, `uid_rfid`, `disable_remarks`, `foto`, `created_at`, `deleted`) VALUES
	(1, 1, 6, '180517', '$2a$08$yGVioDCvSJVV8E9Ooummpejb3o94mBWdl5jYrlYzbHdURR8kBNjES', 'Tyto Mysterious', 1, 'ca355ad', 1, '20613183535fa34dbe8c103.jpg', 1601077104, 0),
	...
	(6, 1, 4, '999111', '$2a$08$Y5xLpJ0ugC0M/WgFnG2YTO2VtWRK6FXSkGiRHJyn2xc7RfC5nI1Su', 'Santoso', 0, 'FF33BC12', 0, 'default.png', 1603263158, 0),
	(7, 7, 2, '888999', '$2a$08$qqRs/amSWxz1up6n2v2LzOnJJ2R/LbVpHxAezH7ieLtnUwWMDSifu', 'Deddy Corbuzier', 1, 'CCA123BB', 0, 'default.png', 1603263290, 0),
	(8, 6, 2, '11223344', '$2a$08$..NhvpD4ToNUmqyuHIOnX.T0Bkdzg45HIudrh76cZ6RuejXQe9hwS', 'User Testing', 1, 'c61b5e2b', 0, 'default.png', 1603374186, 0);
/*!40000 ALTER TABLE `karyawan` ENABLE KEYS */;

-- Dumping structure for table aio.log
...
-- Dumping data for table aio.log: ~355 rows (approximately)
...
-- Dumping structure for table aio.position
...
-- Dumping data for table aio.position: ~6 rows (approximately)
...
-- Dumping structure for table aio.public_reader_rfid
CREATE TABLE IF NOT EXISTS `public_reader_rfid` (
  `id_public_reader_rfid` int(11) NOT NULL AUTO_INCREMENT,
  `uid_rfid` varchar(50) NOT NULL,
  `status` tinyint(1) NOT NULL,
  `token` int(11) NOT NULL,
  `last_update` int(11) NOT NULL,
  PRIMARY KEY (`id_public_reader_rfid`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=latin1;

-- Dumping data for table aio.public_reader_rfid: ~0 rows (approximately)
/*!40000 ALTER TABLE `public_reader_rfid` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `public_reader_rfid` ENABLE KEYS */;

-- Dumping structure for table aio.public_remarks
CREATE TABLE IF NOT EXISTS `public_remarks` (
  `id_public_remarks` int(11) NOT NULL AUTO_INCREMENT,
  `remarks_activity` varchar(200) NOT NULL,
  PRIMARY KEY (`id_public_remarks`)
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=latin1;

-- Dumping data for table aio.public_remarks: ~8 rows (approximately)
/*!40000 ALTER TABLE `public_remarks` DISABLE KEYS */;
INSERT INTO `public_remarks` (`id_public_remarks`, `remarks_activity`) VALUES
	...
	(7, 'Hydrolic '),
	(8, 'lainnya');
/*!40000 ALTER TABLE `public_remarks` ENABLE KEYS */;

-- Dumping structure for table aio.remarks_room
CREATE TABLE IF NOT EXISTS `remarks_room` (
  `id_remarks_room` int(11) NOT NULL AUTO_INCREMENT,
  `id_room` int(11) NOT NULL,
  `id_karyawan` int(11) NOT NULL,
  `remarks_text` varchar(200) NOT NULL,
  `waktu_remarks` int(11) NOT NULL,
  PRIMARY KEY (`id_remarks_room`)
) ENGINE=InnoDB AUTO_INCREMENT=19 DEFAULT CHARSET=latin1;

-- Dumping data for table aio.remarks_room: ~18 rows (approximately)
/*!40000 ALTER TABLE `remarks_room` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `remarks_room` ENABLE KEYS */;

-- Dumping structure for table aio.room
...
-- Dumping data for table aio.room: ~6 rows (approximately)
/*!40000 ALTER TABLE `room` DISABLE KEYS */;
INSERT INTO `room` (`id_room`, `id_department`, `nama_room`, `type`, `need_remarks`, `created_at`, `deleted`, `flag_dashboard`, `open`, `auto`, `relay_open`, `img_room`) VALUES
	(1, 1, 'Workshop', 'public', 1, 1601043846, 0, 1, 0, 0, 0, 0),
	(2, 2, 'Ruang Tunggu', 'public', 0, 1601044256, 0, 0, 0, 0, 0, 0),
	(3, 1, 'Boiler 12 Tph', 'restricted', 0, 1601044279, 0, 0, 0, 0, 0, 0),
	(4, 1, 'Compressor High Presssure', 'restricted', 0, 1601045652, 0, 0, 0, 0, 0, 0),
	(5, 5, 'Production Workshop', 'public', 1, 1603092753, 0, 0, 0, 0, 0, 0),
	(6, 2, 'Admin IT Support', 'restricted', 0, 1603092788, 0, 0, 0, 0, 0, 0);
/*!40000 ALTER TABLE `room` ENABLE KEYS */;

-- Dumping structure for table aio.secret_key
...
-- Dumping data for table aio.telegram: ~0 rows (approximately)
/*!40000 ALTER TABLE `telegram` DISABLE KEYS */;
/*!40000 ALTER TABLE `telegram` ENABLE KEYS */;

-- Dumping structure for table aio.user
...
-- Dumping data for table aio.user: ~5 rows (approximately)
/*!40000 ALTER TABLE `user` DISABLE KEYS */;
INSERT INTO `user` (`id_user`, `id_department`, `nama`, `email`, `username`, `password`, `image`, `role`, `deleted`) VALUES
	(1, 0, 'Tyto Mulyono', 'tyto@tytomulyono.com', 'tyto', '$2a$08$3WyRJUHBqEG.sQ4yYTLxqOAXyqApz5/4AMZ73kauVsah1QfyKe7yC', 'superadmin.png', 1, 0),
